...
@GenerateNiceMocks([
  MockSpec<SharedPreferencesTest>(),
])
void main() {
  ...
  group('getLastNumberTrivia', () {
    ...
    test('should throw a CacheException wshen there is not a cached value', () {
      // arrange
      ...
      // we don't need to verify here again it has already verified in the above test.
